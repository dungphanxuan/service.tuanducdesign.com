...
sections:
  ...
  - section_id: ''
    ...
    pricing_plans:
      - title: CÀI ĐẶT WEBSITE
        ...
        actions:
          - label: Sử dụng gói này
            url: 'https://m.me/121349286117840?ref=caidatwebsite'
            style: primary
            has_icon: false
            icon: arrow-left
            icon_position: left
  ...
  - section_id: ''
    ...
    subtitle: >-
      Ngoài cung cấp các dịch vụ về VPS và Website ra, Thì bên cạnh đó chúng tôi
      còn cung cấp các dịch vụ về WordPress
    background: gray
    pricing_plans: []
    type: section_pricing
  - section_id: ''
