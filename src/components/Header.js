              ...
              <div className="inner">
                <div className="site-header-inside">
                  <div className="site-branding">
                    ...
                    <p className="site-logo"><Link href={withPrefix('/')} title={_.get(this.props, 'data.config.header.logo_img_alt', null)}><img loading="lazy" src={withPrefix(_.get(this.props, 'data.config.header.logo_img', null))} alt={_.get(this.props, 'data.config.header.logo_img_alt', null)} /></Link></p>
                    )}
