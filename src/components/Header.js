              ...
              <div className="inner">
                <div className="site-header-inside">
                  <div className="site-branding">
                    ...
                    <p className="site-logo"><Link href={withPrefix('/')} title={_.get(this.props, 'data.config.header.logo_img_alt', null)}><img src="/images/placeholder.svg" loading="lazy" data-src={withPrefix(_.get(this.props, 'data.config.header.logo_img', null))} alt={_.get(this.props, 'data.config.header.logo_img_alt', null)} /></Link></p>
                    )}
                    ...
                    <p className={classNames('site-title', {'screen-reader-text': _.get(this.props, 'data.config.header.logo_img', null)})}><Link href={withPrefix('/')} title={_.get(this.props, 'data.config.title', null)}>{_.get(this.props, 'data.config.title', null)}</Link></p>
                    }
                  </div>
                  {(_.get(this.props, 'data.config.header.nav_links', null) && _.get(this.props, 'data.config.header.has_nav', null)) && (<React.Fragment>
                  <nav id="main-navigation" className="site-navigation" aria-label="Main Navigation" temprop="mainEntity" itemscope="itemscope" itemtype="https://schema.org/SiteNavigationElement">
