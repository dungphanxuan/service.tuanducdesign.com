    ...
    render() {
        ...
        return (
            <Link href={withPrefix(_.get(action, 'url', null))}
              ...
              className={classNames({'button': (action_style === 'primary') || (action_style === 'secondary'), 'secondary': action_style === 'secondary', 'has-icon': _.get(action, 'has_icon', null)})} title={_.get(action, 'label', null)}/>
